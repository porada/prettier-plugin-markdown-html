<p align="center">
    <a href="https://github.com/porada/prettier-plugin-markdown-html">
        <picture>
            <source
                srcset="https://github.com/porada/prettier-plugin-markdown-html/blob/main/.github/assets/prettier-plugin-markdown-html-dark-scheme@3x.png?raw=true"
                media="(prefers-color-scheme: dark)"
            />
            <source
                srcset="https://github.com/porada/prettier-plugin-markdown-html/blob/main/.github/assets/prettier-plugin-markdown-html-light-scheme@3x.png?raw=true"
                media="(prefers-color-scheme: light)"
            />
            <img
                src="https://github.com/porada/prettier-plugin-markdown-html/blob/main/.github/assets/prettier-plugin-markdown-html-light-scheme@3x.png?raw=true"
                width="520"
                alt=""
            />
        </picture>
